...
// #14 Create a function called spiderTest that takes in an object that is an actor,
// it looks to see if the actor's name is Andrew Garfield and changes the actor object to have a property called spiderRating with a value of 10.
...
function spiderTest(actor){
	...
	else actor.spiderRating = "not a spiderman";
}
